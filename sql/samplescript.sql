...
ALTER TABLE Staff (e_id, fname, lname, designation, dob, hire_date, primary_dept,  city) ADD FOREIGN KEY (primary_dept) REFERENCES Service_department(code) ON DELETE SET NULL;
